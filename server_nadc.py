...
########### SSH pi in the rotor
# PARAMETERS 
SSH_ADDRESS = "192.168.0.28"
SSH_USERNAME = "pi"
SSH_PASSWORD = "144e2abg"
SSH_COMMAND = "python ~/Thesis_repository/rotor_nadc.py "+socket.gethostbyname(socket.gethostname())
#SSH creation
...
# PARAMETERS
SSH_ADDRESS2 = "192.168.0.29"
SSH_USERNAME2 = "pi"
SSH_PASSWORD2 = "ignacio"
SSH_COMMAND2 = "python ~/Thesis_repository/stator_nadc.py "+socket.gethostbyname(socket.gethostname())
# SSH creation
...
def threaded_server():
    ...
    while c_flag:
        ...
        while c_flag:
            ...
            #tcom1=time.time()-tcom
            data_sensor_rj = r_socket.recv(1024)
            #tcom2=time.time()-tcom1-tcom
            load_sensor_r = json.loads(data_sensor_rj.decode())
            load_sensor_s = json.loads(data_sensor_sj.decode())

...
SSH_USERNAME = "pi"
SSH_PASSWORD = "thesis"
SSH_COMMAND = "python ~/raspberry_rotor/client_rotor_2.py "+socket.gethostbyname(socket.gethostname())
#SSH creation
...
SSH_COMMAND2 = "python ~/raspberry_stator/client_stator_2.py "+socket.gethostbyname(socket.gethostname())
# SSH creation

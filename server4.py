...
SSH_USERNAME = "pi"
SSH_PASSWORD = "thesis"
SSH_COMMAND = "python ~/raspberry_rotor/rotor4.py "+socket.gethostbyname(socket.gethostname())
#SSH creation
...
SSH_COMMAND2 = "python ~/raspberry_stator/stator4.py "+socket.gethostbyname(socket.gethostname())
# SSH creation

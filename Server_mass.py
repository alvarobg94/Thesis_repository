...
SSH_USERNAME = "pi"
SSH_PASSWORD = "thesis"
SSH_COMMAND = "python ~/raspberry_rotor/client_rotor_mass.py "+socket.gethostbyname(socket.gethostname())
#SSH creation
...
SSH_COMMAND2 = "python ~/raspberry_stator/client_stator_mass.py "+socket.gethostbyname(socket.gethostname())
# SSH creation
...
def threaded_server():
    ...
    with open('data_vector_mass.csv', 'w') as f:
            writer = csv.writer(f)
